...
<head>
  ...
  <title>BEI | Banshu Electric Indonesia</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index3.php">
        ...
        <div class="sidebar-brand-text mx-2">PT.BANSHU ELECTRIC INDONESIA</div>
      </a>
      ...
      <li class="nav-item ">
        <a class="nav-link">
          ...
          <!-- <div class="d-flex align-items-center justify-content-center" class="email">Anda <?php echo $data['level']; ?></div> -->
        </a>
      </li>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseData" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?page=vendor">Data Vendor</a>
            <a class="collapse-item" href="?page=customer">Data Customer</a>
      ...
      <li class="nav-item active">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?page=transaksi">Transaksi Barang</a>
      ...
      <li class="nav-item active">
        ...
        <div id="collapseLaporan" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="?page=laporan_barangmasuk">Laporan Pembelian</a>
            <a class="collapse-item" href="?page=laporan_barangkeluar">Laporan Penjualan</a>
            <a class="collapse-item" href="?page=laporan_stok">Laporan Stok Barang</a>
        ...
        <div class="container-fluid">
          ...
          <section class="content">
            ...
            if ($page == "vendor") {
              ...
              if ($aksi == "tambahvendor") {
                include "page/vendor/tambahvendor.php";
              }
              if ($aksi == "ubahvendor") {
                include "page/vendor/ubahvendor.php";
              }
              if ($aksi == "hapusvendor") {
                include "page/vendor/hapusvendor.php";
              }
            }
            ...
            if ($page == "customer") {
              ...
              if ($aksi == "tambahcustomer") {
                include "page/customer/tambahcustomer.php";
              }
              if ($aksi == "ubahcustomer") {
                include "page/customer/ubahcustomer.php";
              }

              if ($aksi == "hapuscustomer") {
                include "page/customer/hapuscustomer.php";
              }
            }
        ...
        <footer class="sticky-footer bg-white">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright &copy; Banshu Electrics Indonesia 2022</span>
            </div>
          </div>
        </footer>
        <!-- End of Footer -->
  ...
  <script>
    jQuery(document).ready(function($) {
      $('#item_code').change(function() { // Jika Select Box id provinsi dipilih
        var tamp = $(this).val(); // Ciptakan variabel provinsi
        $.ajax({
          type: 'POST', // Metode pengiriman data menggunakan POST
          url: 'page/transaksi/get_barang.php', // File yang akan memproses data
